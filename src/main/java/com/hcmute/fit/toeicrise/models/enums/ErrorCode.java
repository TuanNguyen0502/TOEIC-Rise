...
public enum ErrorCode {
    ...
    CONVERT_LIST_TO_JSON("Cannot convert list to JSON", HttpStatus.INTERNAL_SERVER_ERROR),
    CONVERT_JSON_TO_LIST("Cannot convert JSON to list", HttpStatus.INTERNAL_SERVER_ERROR),

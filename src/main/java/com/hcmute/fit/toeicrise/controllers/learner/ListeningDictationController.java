...
public class ListeningDictationController {
    ...
    public ResponseEntity<?> getListeningDictationByTestAndPart(@PathVariable Long testId,
                                                                @PathVariable Long partId) {
        return ResponseEntity.ok(dictationTranscriptService.getListeningDictation(testId, partId));

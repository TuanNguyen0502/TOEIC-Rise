...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleMultipartException(Exception ex, HttpServletRequest request) {
    ...
    private ResponseEntity<ExceptionResponse> buildResponseEntity(ErrorCode errorCode, String path, Object message) {
        return ResponseEntity.status(errorCode.getHttpStatus())
                .body(ErrorResponseUtil.buildResponseFromErrorCode(errorCode, path, message));
    }
}
...
public interface ILessonService {
    ...
    LessonDetailResponse getLesson(String slug, String email, String learningPathSlug);
    ...
    Lesson getLessonOrderByOrderIndexDesc(Long learningPathId, ELessonLevel level);
}
